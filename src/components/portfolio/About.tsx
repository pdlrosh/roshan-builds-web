import { GraduationCap, Droplets, Ruler } from "lucide-react";
...
const pillars = [
  ...
  },
  {
    ...
    body: "Interior and exterior design thinking woven into engineered building systems.",
  },
  {
    icon: GraduationCap,
      ...
      <div className="grid gap-12 lg:grid-cols-[1.15fr_1fr]">
        <div className="space-y-5 text-base leading-relaxed text-muted-foreground">
          <p>
            ...
            from IHE Delft, specialising in Hydrology and Water Resources. My work sits at the
            meeting point of rigorous water analysis and thoughtful architectural design — from
            catchment-scale flood studies to the sanitary network hidden inside a building.
          </p>
          <p>
          ...
          <p>
            ...
            that are planned for their whole life cycle — and about{" "}
            <span className="font-semibold text-foreground">holistic building design</span>, where
            structure, water, light and interior space are decided together rather than in sequence.
          </p>
        </div>
